class BankAccount {
    ...
    // Setter mathods to access private fields
    public double getbalance() {
        return balance;
    }

    public String setAccountHoladername() {
...
public class Setter_Example {
    public static void main(String[] args) {
        ...
        System.out.println("Account Holder Name" + account.setAccountHoladername());
